...
inline SchedulerConfig GetSchedulerConfig(int64_t memory_limit) {
...
inline SchedulerConfig GetDefaultSchedConfig() {
...
inline CanonicalAsyncOp GpuGetCanonicalAsyncOp(const HloInstruction& hlo) {
  switch (hlo.opcode()) {
