...
class IrEmitterUnnested : public IrEmitter {
 ...
 private:
  ...
  absl::Status EmitFlashAttnForwardThunk(const HloCustomCallInstruction* instr);
  absl::Status EmitFlashAttnVarlenForwardThunk(
      const HloCustomCallInstruction* instr);
  absl::Status EmitFlashAttnBackwardThunk(
      const HloCustomCallInstruction* instr);
  absl::Status EmitFlashAttnVarlenBackwardThunk(
      const HloCustomCallInstruction* instr);
#endif  // GOOGLE_CUDA
